...
const categories = [
  ...
  { name: 'Gadgets', icon: Zap, color: 'bg-yellow-100 text-yellow-600', href: '/category/gadgets' },
  { name: 'Beauty', icon: Heart, color: 'bg-red-100 text-red-600', href: '/category/beauty' },
  { name: 'Music', icon: Disc, color: 'bg-purple-100 text-purple-600', href: '/category/music' },
];
    ...
    <section className="py-8 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 flex gap-8 overflow-x-auto no-scrollbar justify-center">
        {categories.map((cat) => {
          ...
          const targetHref = cat.href || `/category/${cat.name.toLowerCase()}`;
