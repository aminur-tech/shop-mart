...
// Full 15 Gadgets Products JSON Data (পুরো ১৫টা রাখা আছে)
const gadgetsData = [
  {
    id: 1,
...
export default function GadgetsPage() {
  ...
  const itemsPerPage = 4; // ৪টা করে দেখাবে (তোমার রিকোয়েস্ট অনুযায়ী)
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white overflow-hidden">
      ...
      {/* Advanced Search + Filters (আরও স্মার্ট + আইকন যোগ) */}
      <section className="px-4 py-12 max-w-7xl mx-auto" data-aos="fade-up" data-aos-delay="200">
        <div className="bg-slate-100 dark:bg-slate-800 rounded-3xl p-8 shadow-2xl">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="px-6 py-5 bg-blue-600 text-white rounded-full text-lg font-medium hover:bg-blue-700 transition-all shadow-md flex items-center gap-2">
                <FaFilter /> Filter
              </button>
            </div>
          </div>
      ...
      {/* All Products Grid - ৪টা করে + বড় + hover effects + AOS */}
      <section className="px-4 py-20 max-w-7xl mx-auto" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {paginatedProducts.map((product) => (
            <div 
              key={product.id} 
              className="bg-white dark:bg-slate-800 rounded-3xl p-10 shadow-2xl hover:shadow-[0_0_40px_rgba(59,130,246,0.4)] hover:scale-105 transition-all duration-500 group relative overflow-hidden" 
              data-aos="zoom-in-up" 
              data-aos-delay="200"
            >
              {/* Discount Badge */}
              ...
              <button className="w-full bg-blue-600 text-white py-4 rounded-2xl flex items-center justify-center gap-4 hover:bg-blue-700 hover:scale-105 transition-all duration-300 group-hover:shadow-xl text-lg font-bold">
